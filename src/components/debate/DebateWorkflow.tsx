...
export default function DebateWorkflow({ documentId, onStepChange }: DebateWorkflowProps) {
  ...
  const handleSubmit = () => {
    // This function would handle the final submission after all steps are completed
    console.log('Final debate configuration:', debateConfig);
    // Here you would typically make an API call with the configuration
  };
